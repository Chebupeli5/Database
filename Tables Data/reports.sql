INSERT INTO "Huyatina".reports (user_id,file) VALUES
	 ...
	 (4,'{"report_id": "2025-09", "period": "Сентябрь 2025", "total_income": 110000, "total_expenses": 1200, "summary": "Отложена сумма на ремонт. Расходы в норме."}'),
	 (5,'{"report_id": "2025-09", "period": "Сентябрь 2025", "total_income": 130000, "total_expenses": 5000, "summary": "Высокие доходы. Рекомендуется погасить задолженность по кредитной карте."}');
